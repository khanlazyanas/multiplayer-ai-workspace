        ...
        <div className="flex justify-center w-1/3">
          <div className="flex bg-[#050505] p-1 rounded-xl border border-zinc-800 shadow-[inset_0_2px_5px_rgba(0,0,0,0.8)] relative">
            ...
            <button
              ...
              className={`relative z-10 w-[90px] sm:w-[110px] flex items-center justify-center gap-1.5 py-1.5 sm:py-2 text-[10px] sm:text-xs font-bold transition-colors ${activeMode === 'document' ? 'text-white' : 'text-zinc-500 hover:text-zinc-300'}`}
            >
            ...
            <button
              ...
              className={`relative z-10 w-[90px] sm:w-[110px] flex items-center justify-center gap-1.5 py-1.5 sm:py-2 text-[10px] sm:text-xs font-bold transition-colors ${activeMode === 'canvas' ? 'text-white' : 'text-zinc-500 hover:text-zinc-300'}`}
            >
