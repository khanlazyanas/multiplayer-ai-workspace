...
import Canvas from "@/components/editor/Canvas"; // 🔥 Standard Import!
...
function WorkspaceUI({ 
  ...
  return (
    <div className="absolute inset-0 flex flex-col pointer-events-none z-20">
      ...
      <main 
        className={`flex-1 relative w-full overflow-y-auto py-10 px-4 md:px-0 flex justify-center bg-black transition-opacity duration-300 ${activeMode === 'document' ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}
...
export default function RoomPage() {
  ...
  return (
    <div className="relative w-full h-screen bg-[#111111] overflow-hidden text-zinc-200 font-sans custom-scrollbar">
      ...
      {/* Canvas hamesha page par permanently mount rahega bina useMemo/dynamic ke */}
